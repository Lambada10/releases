...
export local_manifest_url="https://raw.githubusercontent.com/lambada-vayu-lab/local_manifest/main/vayu.xml"
...
export kerneltree="https://github.com/Jebaitedneko/android_kernel_xiaomi_vayu" kernelpath="kernel/xiaomi/vayu" kernelbranch="r2"
